...
func emailEntryFromRow(row *sql.Rows) (*EmailEntry, error) {
	...
	err := row.Scan(&id, &confirmedAt, &email, &optOut)
...
type GetEmailBatchQuertParams struct {
	Page  int
	Count int
}

func GetEmailBatch(db *sql.DB, params GetEmailBatchQuertParams) ([]EmailEntry, error) {
